...
func createRandomUser(t *testing.T) User {
	...
	require.NotZero(t, user.Discordid)
...
func TestGetUser(t *testing.T) {
	...
	user2, err := testQueries.GetUser(context.Background(), user1.Discordid)
...
func TestDeleteUser(t *testing.T) {
	user1 := createRandomUser(t)
	err := testQueries.DeleteUser(context.Background(), user1.Discordid)
	require.NoError(t, err)
